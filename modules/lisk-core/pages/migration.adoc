...
normal upgrade, see link:introduction.adoc#upgrade-vs-migration[Upgrade
vs Migration].
____
...
link:introduction.adoc#lisk-core-distributions[setup] steps before
...
link:setup/binary.adoc[Binary installation].
...
the blockchain link:introduction.adoc#snapshots[from snaphot] or
...
link:introduction.adoc#upgrade-vs-migration[upgrade process].

...
{firstname} loves to hear from other chroniclers. emoji:turtle[100x]

[plantuml]
----
[product documentation] --> (Getting started) : contains
[product documentation] --> (Cookbooks/ How-to Guides) : contains
[product documentation] --> (Specifications/ References) : contains
(Getting started) --> (Tutorials) : contains
(Getting started) --> (Explanations) : contains

note bottom of (Tutorials) : learning-oriented
note bottom of (Explanations) : understanding-oriented
note bottom of (Cookbooks/ How-to Guides) : problem-oriented
note bottom of (Specifications/ References) : information-oriented
----

...
parameters for the
link:../../../../lisk-sdk/configuration.md#the-genesis-block[genesis
block] and the
...
See link:../../../../lisk-sdk/introduction.md#pre-installation[SDK
Pre-Install section].
____
...
See also section link:../interact-with-network.adoc[Interact with the
network].
